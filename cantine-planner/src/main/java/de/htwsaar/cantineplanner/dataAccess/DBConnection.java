...
//            dsl.update(Users.USERS).set(Users.USERS.DONT_SHOW_MEAL, allergies).where(Users.USERS.USERID.eq(userId)).execute();
//            return true;
//        }
//    }
//
...
//        try (Connection connection = dataSource.getConnection()) {
//            DSLContext dsl = getDSLContext(connection);
//            String hashedPassword = dsl.select(Users.USERS.PASSWORD).from(Users.USERS).where(Users.USERS.USERNAME.eq(username)).fetchOne(Users.USERS.PASSWORD);
//
...
//        try (Connection connection = dataSource.getConnection()) {
//            DSLContext dsl = getDSLContext(connection);
//            String hashedPassword = dsl.select(Users.USERS.PASSWORD).from(Users.USERS).where(Users.USERS.USERID.eq(userID)).fetchOne(Users.USERS.PASSWORD);
//
//            if (hashedPassword == null || !PasswordUtil.verifyPassword(plainTextPassword, hashedPassword)) {
...
//            }
//
//            return dsl.select(Users.USERS.USERID).from(Users.USERS).where(Users.USERS.USERNAME.eq(username)).fetchOne(Users.USERS.USERID);
//        }
//    }
//
//    /**
...
//                setSteps = (setSteps == null) ? updateQuery.set(Meals.MEALS.NAME, meal.getName()) : setSteps.set(Meals.MEALS.NAME, meal.getName());
//            }
//            if (meal.getPrice() != null) {
//                setSteps = (setSteps == null) ? updateQuery.set(Meals.MEALS.PRICE, meal.getPrice()) : setSteps.set(Meals.MEALS.PRICE, meal.getPrice());
//            }
//            if (meal.getCalories() != null) {
//                setSteps = (setSteps == null) ? updateQuery.set(Meals.MEALS.CALORIES, meal.getCalories()) : setSteps.set(Meals.MEALS.CALORIES, meal.getCalories());
//            }
//            if (meal.getAllergy() != null) {
//                setSteps = (setSteps == null) ? updateQuery.set(Meals.MEALS.ALLERGY, meal.getAllergy()) : setSteps.set(Meals.MEALS.ALLERGY, meal.getAllergy());
//            }
//            if (meal.getMeat() != null) {
//                setSteps = (setSteps == null) ? updateQuery.set(Meals.MEALS.MEAT, meal.getMeat()) : setSteps.set(Meals.MEALS.MEAT, meal.getMeat());
//            }
//
//            if (setSteps != null) {
//                setSteps.where(Meals.MEALS.MEAL_ID.eq(meal.getMealId())).execute();
//            }
//        }
//    }
//
...
//            }
//            return dsl.select(Users.USERS.ROLE).from(Users.USERS).where(Users.USERS.USERID.eq(UserID)).fetchOne(Users.USERS.ROLE) == 1;
//        }
//    }
//
//    /**
...
//            dsl.insertInto(Users.USERS).set(Users.USERS.USERNAME, username).set(Users.USERS.PASSWORD, hashedPassword).set(Users.USERS.EMAIL, email).set(Users.USERS.ROLE, 0).execute();
//
//            return dsl.selectFrom(Users.USERS).where(Users.USERS.USERNAME.eq(username)).fetchOne();
//        }
//    }
...
//            }
//
//            dsl.insertInto(Meals.MEALS).set(Meals.MEALS.NAME, meal.getName()).set(Meals.MEALS.PRICE, meal.getPrice()).set(Meals.MEALS.CALORIES, meal.getCalories()).set(Meals.MEALS.ALLERGY, meal.getAllergy()).set(Meals.MEALS.MEAT, meal.getMeat()).set(Meals.MEALS.DAY, meal.getDay()).execute();
//
...
//        try (Connection connection = dataSource.getConnection()) {
//            DSLContext dsl = getDSLContext(connection);
//            return dsl.select(DSL.median(Review.REVIEW.RATING)).from(Review.REVIEW).where(Review.REVIEW.MEAL_ID.eq(mealId)).fetchOne(0, double.class);
//        }
//    }
//
//
...
//            }
//            return dsl.select().from(Review.REVIEW).join(Meals.MEALS).on(Review.REVIEW.MEAL_ID.eq(Meals.MEALS.MEAL_ID)).where(Meals.MEALS.NAME.eq(mealName)).fetchInto(ReviewRecord.class);
//        }
//    }
//
//
...
//        try (Connection connection = dataSource.getConnection()) {
//            DSLContext dsl = getDSLContext(connection);
//            dsl.insertInto(Review.REVIEW).set(Review.REVIEW.MEAL_ID, givenReview.getMealId()).set(Review.REVIEW.RATING, givenReview.getRating()).set(Review.REVIEW.COMMENT, givenReview.getComment()).set(Review.REVIEW.USERID, givenReview.getUserid()).execute();
//            return true;
//        }
//    }
//
...
//            int rowsAffected = create.update(DSL.table("meals")).set(DSL.field("day"), day).where(DSL.field("Name").eq(mealName)).execute();
//            if (rowsAffected == 0) {
...
//                dsl.update(DSL.table("users")).set(DSL.field("password"), hashedPassword).where(DSL.field("userid").eq(currentUserId)).execute();
//            }
//
//            // Update the user's email if provided
//            if (newEmail != null && !newEmail.isEmpty()) {
//                dsl.update(DSL.table("users")).set(DSL.field("email"), newEmail).where(DSL.field("userid").eq(currentUserId)).execute();
//            }
//        }
//    }
//
...
//        try (Connection connection = dataSource.getConnection()) {
//            DSLContext dsl = getDSLContext(connection);
//            return dsl.selectFrom(Meals.MEALS).orderBy(Meals.MEALS.PRICE.asc()).fetchInto(MealsRecord.class);
//        }
//    }
//
...
//                Double medianRating = dsl.select(DSL.median(Review.REVIEW.RATING)).from(Review.REVIEW).where(Review.REVIEW.MEAL_ID.eq(record.getMealId())).fetchOne(0, double.class);
...
//        try (Connection connection = dataSource.getConnection()) {
//            DSLContext dsl = getDSLContext(connection);
//            return dsl.selectFrom(Meals.MEALS).orderBy(Meals.MEALS.CALORIES.asc()).fetchInto(MealsRecord.class);
//        }
//    }
//
//    /**
...
//            DSLContext dsl = getDSLContext(connection);
//
//            UsersRecord user = dsl.selectFrom(Users.USERS).where(Users.USERS.USERID.eq(userId)).fetchOne();
//
//            if (user == null) {
//                throw new UserDoesntExistException("The user with the given UserId doesn't exist!");
//            }
